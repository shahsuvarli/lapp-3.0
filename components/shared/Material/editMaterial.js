...
import { materialWindow } from "@/features/crmSlice";
...
function Material({ quote, material }) {
  ...
  const [rows, setRows] = React.useState([blankData]);
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="overflow-y-scroll w-11/12 py-7 px-5 box-border border-[0.5px] border-solid border-[#7b7a7a4a] rounded-md">
              ...
              <FieldArray name="rows">
                {() => (
                  <div>
                    <table>
                      <thead>
                        <tr>
                          ...
                          <th className="font-bold text-[#737373] align-text-top">
                            {/* <span className="rounded-md border border-solid border-[#737373]">X</span> */}
                    ...
                    <div className="absolute bottom-5 w-11/12 flex justify-center items-center box-border">
                      <div className="w-full flex justify-end items-center box-border gap-5">
                        <button
                          type="button"
